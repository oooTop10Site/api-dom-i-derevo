...
@section('content')
    <div class="row m-0">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center row">
                        ...
                        <div class="col-sm-6 text-right">
                            <a href="{{ route('service.create', $_GET) }}" class="btn btn-primary" title="{{ __('main.button.create') }}"><i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                            ...
                            @foreach($data as $key => $item)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-end">
                                        <a href="{{ route('service.edit', array_merge(['service' => $item->id], $_GET)) }}" class="btn btn-primary mr-2" title="{{ __('main.button.edit') }}"><i class="fas fa-pen"></i></a>
                                        <form action="{{ route('service.destroy', array_merge(['service' => $item->id], $_GET)) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
        ...
        <div class="col-md-4 pr-0">
            <form class="card" id="filter-form" onsubmit="filterForm('{{ route('service.index') }}');return false;">
